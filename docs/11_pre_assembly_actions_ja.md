...
| 6 | ☐ | IX-ULWCD を手元に用意する(所有品、借用、または購入)。そのうえで M6(外径・外形)と M8(ピント状態の前玉高さ)を測る。ホルダーの試作品か購入品で M23(積み上げ高さ)も測る | 凍結ゲートの残り 3 項目。アームの細い部分の長さ、コンデンサとの余裕 | `05` M6/M8 |
...
> **凍結ゲート: M1, M3, M4, M6, M7, M8, M10, M15, M23**
>
...
| `HOLDER_L`(ホルダーの積み上げ高さ) | 14 mm(APX) | **M23** |
