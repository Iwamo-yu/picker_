...
2. **Clearance sweep (OpenCascade minimum distance).** All 96 wells at pick height and at safe-Z (the lower bound of the safe-Z corridor: highest moving plate or clip feature + 5 mm), plus a 35-point grid over the full 150 × 100 travel at safe-Z and at the top of the Z stroke. Moving parts are checked against the IX73 envelope, the condensers, the plate and the pump.
...
10. **Collision fuse.** The arm hangs on a magnet-preloaded kinematic mount (e.g. Thorlabs KB25/M, about 16 N holding force, P12). It is a **kinematic repositioner, not a force limiter**: its release force at the tip is about 1.67 N. That protects the plate, stage and condenser from a stalled axis (below the 5 N plate limit, placeholder), but **not the capillary**, whose estimated lateral breaking force is 0.15–1.18 N (`06_electrical.md`). Treat capillaries as consumables in a crash, and re-calibrate after any detach. A compliant low-force stage at the holder is open decision D9.
