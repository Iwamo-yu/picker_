...
A single fixed capillary angle serves the 96-well plate well but wastes the larger wells. The holder therefore sits on **exchangeable angle blocks ({{ANGLE_BLOCKS_TXT}})** that seat on the kinematic mount. The depth stop in the collet sets the **exposed capillary length** for each plate format. Each block is a fixed, pre-designed geometry, which is more repeatable than a continuous tilt. Changing a block only needs a 3-point image re-calibration.
...
|---|---|---|---|---|---|
| 96-well U-bottom (Corning 7007) | {{FMT96_ANGLE:.0f}}° | {{FMT96_EXP:.0f}} mm | {{FMT96_RIM:.2f}} mm | {{FMT96_COND:.1f}} mm | {{FMT96_BLOCK:.0f}} % |
| 48-well (Corning 3548) | {{FMT48_ANGLE:.0f}}° | {{FMT48_EXP:.0f}} mm | {{FMT48_RIM:.2f}} mm | {{FMT48_COND:.1f}} mm | {{FMT48_BLOCK:.0f}} % |
| 24-well (Corning 3524) | {{FMT24_ANGLE:.0f}}° | {{FMT24_EXP:.0f}} mm | {{FMT24_RIM:.2f}} mm | {{FMT24_COND:.1f}} mm | {{FMT24_BLOCK:.0f}} % |
| 12-well (Corning 3513) | {{FMT12_ANGLE:.0f}}° | {{FMT12_EXP:.0f}} mm | {{FMT12_RIM:.2f}} mm | {{FMT12_COND:.1f}} mm | {{FMT12_BLOCK:.0f}} % |
| 6-well (Corning 3516) | {{FMT6_ANGLE:.0f}}° | {{FMT6_EXP:.0f}} mm | {{FMT6_RIM:.2f}} mm | {{FMT6_COND:.1f}} mm | {{FMT6_BLOCK:.0f}} % |
...
4. **The 12-well at 30° has only {{FMT12_RIM:.2f}} mm rim clearance**, which is thin for off-centre objects. Keep the 20° block as that plate's fallback.
