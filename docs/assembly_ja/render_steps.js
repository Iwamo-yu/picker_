...
(async () => {
  ...
  await shoot('partmap-labels', path.join(ROOT, 'docs/assembly_ja/img', 'partlabels_overall.png'), 1400, 900);
  await shoot('partmap-head-labels', path.join(ROOT, 'docs/assembly_ja/img', 'partlabels_head.png'), 1400, 900);
