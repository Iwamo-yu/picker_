<!-- GENERATED from docs/src/08_capillary_sizing.md by cad/render_docs.py - edit the source, not this file -->
...
| L | 600–800 µm | 2.0 / 1.12 (WPI 1B200-4) | 1.4–1.9 | 12.3° | 0.87 mm | MFR (S14) |
| **L′** | 800–1000 µm | **2.00 / 1.56 thin wall (WPI, no filament)** | 1.56–1.95 | 12.3° | 0.87 mm | MFR (S14) |

Notes:

- **1 mm objects.** A standard-wall 2.0 mm capillary (ID 1.12) is only 1.12 × a 1 mm object, which is too tight for soft, deformable or rough spheroids. **Use the thin-wall 2.00/1.56 mm capillary (WPI, catalogue excerpt S14)** for objects of 0.8–1 mm. Class L then covers only 600–800 µm.
...
- Thin-wall 2.00/1.56 availability and price in Japan; whether a filament-free version is stocked.
